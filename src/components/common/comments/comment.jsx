        ...
        <>
          <div className="flex items-center  gap-5 pt-[1rem]">
            ...
            <div className="flex-1 flex justify-between ">
              <div>
                <h3 className="text-sm capitalize mr-1 ">{getUserData?.username}</h3>
              ...
              <div className="relative">
                ...
                {currentUser && currentUser?.uid !== userId && (
                  <div className="flex justify-end">
                    <button
                      onClick={sendRequest}
                      className="rounded-full border border-gray-400 bg-green-500  text-sm px-1 sm:px-2 sm:py-1 py-0"
                    >
                      send request
                    </button>
                  </div>
          ...
          <button
            ...
            onClick={() => setShowNestedReply(!showNestedReplies)}
          >
        ...
        <div className="bg-white shadows p-4">
          ...
          <div className="flex items-center justify-end gap-2">
            <button
              ...
              className="rounded-full text-sm w-fit font-serif bg-red-400 py-1 px-2"
            >
              Cancel
            </button>
            <button
              onClick={handleEdit}
              className="rounded-full text-sm w-fit font-serif bg-green-400 py-1 px-2"
            >
              Update
            </button>
          </div>
...
const Button = ({ click, title }) => {
  return (
    <button
      onClick={click}
      className="p-2 hover:bg-gray-400 text-left text-sm w-full"
    >
      {title}
    </button>
  );
