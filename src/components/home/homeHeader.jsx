    ...
    <header className="border-b border-gray-200 bg-yellow-400">
      ...
      <div className="size h-[60px] flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:flex w-full z-50">
        ...
        <div className="flex items-center gap-2 sm:gap-7">
          ...
          {pathname === "/write" ? (
            ...
            <button
              className="px-2 hover:bg-violet-400 
      ...
      <div
        className={`fixed top-[60px] left-0 w-full bg-white shadow-lg transition-transform ${
          searchModel ? "translate-y-0" : "-translate-y-full"
