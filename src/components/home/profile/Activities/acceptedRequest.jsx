...
const AcceptedRequest = () => {
    ...
    return (
        <div className='flex gap-2 flex-col '>
            <h2 className='font-bold font-serif md:text-xl'>Accepted Requests</h2>
                ...
                acceptedList.map(notification => (
                    ...
                    <div className='flex gap-2'>  <img
                      ...
                      <p> {new Date(notification.timestamp).toLocaleString()}</p>
                            ...
                            className=' text-black font-serif  text-sm mb-1 px-1 md:rounded-full md:px-2 bg-green-400 md:py-1 rounded-md '>Chatroom</button>
